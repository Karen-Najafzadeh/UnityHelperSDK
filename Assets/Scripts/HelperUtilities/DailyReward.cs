...
namespace UnityHelperSDK.Rewards
{
    ...
    public class DailyRewardManager : MonoBehaviour
    {
        ...
        public async void ClaimTodayReward()
        {
            if (!CanClaimToday())
            {
            ...
            await PrefsHelper.Set<GamePrefs>(GamePrefs.DailyRewardLastClaimed, DateTime.UtcNow.ToString());
            await PrefsHelper.Set<GamePrefs>(GamePrefs.DailyRewardStreak , CurrentStreak + 1);
