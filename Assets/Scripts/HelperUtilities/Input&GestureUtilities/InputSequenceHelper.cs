...
/// <summary>
/// InputSequenceHelper: Singleton for detecting complex input patterns:
/// - Tap/Combo sequences
/// - Swipes
/// - Arbitrary shapes (using $1 Unistroke Recognizer)
/// </summary>
public class InputSequenceHelper : MonoBehaviour
{
    public static InputSequenceHelper Instance { get; private set; }

    private const float DefaultBufferTime = 1f;
    private List<PointerEvent> _buffer = new List<PointerEvent>();
    ...
    /// <summary>Register a new gesture definition.</summary>
    ...
    /// <summary>Sample current pointer/touch and store event.</summary>
    ...
    /// <summary>Remove old events outside of bufferTime.</summary>
    ...
    /// <summary>Run detection for all registered gestures.</summary>
    ...
    {
        // Simplest: match sequence of down/up for specific key codes
    ...
    private bool ShapeMatch(GestureDefinition g)
    {
        ...
        // Gather positions between last down and up
